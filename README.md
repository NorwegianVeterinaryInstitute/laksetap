...
[inst/app/www/labels_nb_no.json](inst/app/www/labels_nb_no.json).
Translating the `.json` file and providing the new file as an
`golem option` in `run_app.R` will make the app use a different language
for labels on UI inputs, and other HTML elements. The long form text
