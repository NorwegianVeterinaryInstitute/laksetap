...
# Monthly mortality
Let $\mathit{S}$ denote a subset of the farms, representing a geographical aggregation level. The level might be county, management area or national. Then, for subset $\mathit{S}$ the following numbers are calculated:
